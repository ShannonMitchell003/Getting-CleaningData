...
_From looking at the files in the downloaded folder, there are two metadata files (containing the names of features & activities), and the actual raw data (within the folders train & test)_
...
```{r}
##First need to look at the variable names:
names(SumData)
```
Some variables that can be more descriptive:
1. Acc -> Accelerometer
2. Gyro -> Gyroscope
3. BodyBody -> Body
4. Mag -> Magnitude
